...
type FakeDatasets struct {
	Fake *FakeMetaedgeV1alpha1
	ns   string
}

var datasetsResource = schema.GroupVersionResource{Group: "metaedge.io", Version: "v1alpha1", Resource: "datasets"}

var datasetsKind = schema.GroupVersionKind{Group: "metaedge.io", Version: "v1alpha1", Kind: "Dataset"}
