...
type FakeDatasets struct {
	Fake *FakeShoggothV1alpha1
	ns   string
}

var datasetsResource = schema.GroupVersionResource{Group: "shoggoth.io", Version: "v1alpha1", Resource: "datasets"}

var datasetsKind = schema.GroupVersionKind{Group: "shoggoth.io", Version: "v1alpha1", Kind: "Dataset"}
