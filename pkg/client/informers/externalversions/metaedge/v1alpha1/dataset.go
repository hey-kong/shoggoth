...
import (
	"context"
	metaedgev1alpha1 "metaedge/pkg/apis/metaedge/v1alpha1"
	...
	v1alpha1 "metaedge/pkg/client/listers/metaedge/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MetaedgeV1alpha1().Datasets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MetaedgeV1alpha1().Datasets(namespace).Watch(context.TODO(), options)
			},
		},
		&metaedgev1alpha1.Dataset{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *datasetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&metaedgev1alpha1.Dataset{}, f.defaultInformer)
}
