...
import (
	...
	shoggothv1alpha1 "github.com/hey-kong/shoggoth/pkg/apis/shoggoth/v1alpha1"
	...
	v1alpha1 "github.com/hey-kong/shoggoth/pkg/client/listers/shoggoth/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ShoggothV1alpha1().Datasets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ShoggothV1alpha1().Datasets(namespace).Watch(context.TODO(), options)
			},
		},
		&shoggothv1alpha1.Dataset{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *datasetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&shoggothv1alpha1.Dataset{}, f.defaultInformer)
}
