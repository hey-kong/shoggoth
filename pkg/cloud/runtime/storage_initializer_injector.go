...
const (
	...
	downloadInitalizerImage         = "kubeedge/metaedge-storage-initializer:v0.3.0"

	downloadInitalizerPrefix     = "/downloads"
	downloadInitalizerVolumeName = "metaedge-storage-initializer"
	...
	defaultVolumeName = "metaedge-default-volume-name"
)
