...
func SendToEdge(nodeName string, msg *messagelayer.Message) error {
...
func ReceiveFromEdge() (nodeName string, msg messagelayer.Message, err error) {
...
func SendToCloud(nodeName string, msg messagelayer.Message) error {
...
type ReadMsgFunc func() (messagelayer.Message, error)

// WriteMsgFunc defines write msg callback
type WriteMsgFunc func(messagelayer.Message) error
